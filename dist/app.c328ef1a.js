    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            link = "".concat(BASE_URL, "/pokemon?limit=").concat(limit, "&offset=").concat(offset);
            _context.next = 3;
...
function () {
  ...
  return function getDados(_x) {
    return _ref2.apply(this, arguments);
  };
}();

var setPaginator = function setPaginator(flag) {
  if (flag) {
...
var setTotal = function setTotal(t) {
  $("#total-pokemon").text("Pagina ".concat(pag, " de ").concat(max_pag, " | Total de Pok\xE9mons: ").concat(t));
};

var setProximo = function setProximo() {
  if (!proximo) {
...
var setAnterior = function setAnterior() {
  if (!anterior) {
...
var clickProximo = function clickProximo() {
  $("#proximo-pokemon a").click(function (event) {
    event.preventDefault();

    if (proximo) {
      var urlParams = new URLSearchParams(proximo.replace("".concat(BASE_URL, "/pokemon?"), ""));
      pag++;
      offset = urlParams.get("offset");
      limit = urlParams.get("limit");
      getLista().then(function (res) {
        addTodosToDOM(res);
      });
    }
  });
...
var clickAnterior = function clickAnterior() {
  $("#anterior-pokemon a").click(function (event) {
    event.preventDefault();

    if (anterior) {
      var urlParams = new URLSearchParams(anterior.replace("".concat(BASE_URL, "/pokemon?"), ""));
      pag--;
      offset = urlParams.get("offset");
      limit = urlParams.get("limit");
      getLista().then(function (res) {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _axios.default.get("".concat(BASE_URL, "/type"));

          case 2:
            res = _context3.sent;
            TIPOS = res.data.results;
            data = TIPOS.map(function (e) {
              return {
                id: e.name,
                text: e.name
              };
...
var createLi = function createLi(item) {
  ...
  li.setAttribute("class", "col card-pokemon"); // li.setAttribute("class", "");

  li.innerHTML = createCard(item);
  return li;
};

var createCard = function createCard(p) {
  var name = p.name;
  var id = p.url.replace("https://pokeapi.co/api/v2/pokemon/", "").replace("/", "");
  return "<div  class=\"card\" style=\"width: 13rem; margin: 10px\">\n  <img loading=lazy id=\"img-".concat(id, "\" src=\"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/").concat(id, ".png\" class=\"card-img-top\" alt=\"").concat(name, "\">\n  <div class=\"card-body\">\n    <h5 class=\"card-title\">").concat(name, "</h5>\n    <p class=\"card-text\">Codigo ").concat(id, " </p>\n  </div>\n  <div class=\"card-body\">\n  <a target=\"_blank\" href=\"https://pokedex.org/#/pokemon/").concat(id, "\" class=\"card-link\">Saiba mais</a>\n  </div>\n</div>");
};

var addTodosToDOM = function addTodosToDOM(all) {
  var ul = document.querySelector(".lista-pokemon");
  $(".lista-pokemon div.card-pokemon").remove();
  var resultado = all.results;

  if (Array.isArray(resultado) && resultado.length > 0) {
    resultado.map(function (todo) {
...
var form = document.querySelector("form#form-buscar");
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            event.preventDefault();
            $(".tipos-pokemons").show();
            tmp = document.querySelector("#pokemon-input").value;
            console.log(tmp);
...
function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            link = "".concat(BASE_URL, "/type/").concat(t);
            _context5.next = 4;
            return _axios.default.get(link);
          ...
          case 4:
            ...
            tmp = {
              results: res.data.pokemon.map(function (e) {
                return e.pokemon;
              }) || []
            };
            setPaginator(false);
            addTodosToDOM(tmp);
            $(".tipos-pokemons").text("Total de ".concat(tmp.results.length, " | Tipo: ").concat(t).toUpperCase());
            setLink(link);
            _context5.next = 18;
            break;

          case 13:
            _context5.t0 = addTodosToDOM;
            _context5.next = 16;
            return getLista();
  ...
  return function listByType(_x3) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "49111" + '/');
